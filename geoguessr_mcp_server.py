...
def format_softhouse_daily(
    ...
    """Format Softhouse daily challenge message. If challenge_number > 1, appends ' #2', '#3', etc. Results section uses results_date_str for 'Previous challenge results (DD/MM/YYYY)'."""
